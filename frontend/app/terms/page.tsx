      ...
      <div className="relative space-y-8">
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed text-sm md:text-base">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white tracking-tight">1. Services & Engagement</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white tracking-tight">2. Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white tracking-tight">3. User Conduct</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-gray-800/60">
            <h2 className="text-xl font-bold text-white tracking-tight">5. Updates & Modification</h2>
            <p>
