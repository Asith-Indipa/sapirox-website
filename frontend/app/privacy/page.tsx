    ...
    <div className="relative min-h-[85vh] pt-32 pb-20 px-6 max-w-4xl mx-auto">
      ...
      <div className="relative space-y-8">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed text-sm md:text-base">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-foreground tracking-tight">2. How We Use Your Information</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-foreground tracking-tight">3. Data Retention & Security</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-foreground tracking-tight">4. Third-Party Sharing</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-foreground tracking-tight">5. Your Consent</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-border/60">
            <h2 className="text-xl font-bold text-foreground tracking-tight">6. Contact Information</h2>
            <p>
